...
<body>
    ...
    <form action="<?php echo e(route('recommendations.save')); ?>" method="POST">
        <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        initializeAutocomplete('searchSkills', 'selectedSkills', 'selectedSkillsInput', "<?php echo e(url('autocomplete-skills')); ?>");
        initializeAutocomplete('searchMajors', 'selectedMajors', 'selectedMajorsInput', "<?php echo e(url('autocomplete-majors')); ?>");
    </script>
</body>
</html>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/raystores/Downloads/Caredge/resources/views/findjob.blade.php ENDPATH**/ ?>